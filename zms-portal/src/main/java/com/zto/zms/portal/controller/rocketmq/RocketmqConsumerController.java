...
@RestController
@RequestMapping("/api/rocketmq/consumer")
public class RocketmqConsumerController {

    public static final Logger logger = LoggerFactory.getLogger(RocketmqConsumerController.class);
    ...
    public Result<PageResult<ConsumerSummary>> consumerLatenciesByPage(ConsumerQueryDTO consumerQueryDto) {
        return Result.success(monitorServiceManager.getConsumerSummariesByPage(BrokerType.ROCKETMQ.getName(),
