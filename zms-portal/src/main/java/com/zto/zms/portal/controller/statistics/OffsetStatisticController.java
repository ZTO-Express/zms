...
import com.zto.zms.portal.service.OffsetStatisticMapperService;
...
public class OffsetStatisticController {

    @Autowired
    OffsetStatisticMapperService offsetStatisticMapperService;

    @GetMapping(value = "/queryClusterOffset")
    public Result<List<OffsetStatisticDTO>> queryClusterOffset(OffsetStatisticQueryVO queryVo) {
        ...
        return Result.success(offsetStatisticMapperService.queryClusterOffset(queryVo));
    }

    @GetMapping(value = "/queryTopicOffset")
    public Result<List<OffsetStatisticDTO>> queryTopicOffset(OffsetStatisticQueryVO queryVo) {
        ...
        return Result.success(offsetStatisticMapperService.queryTopicOffset(queryVo));
    }
