...
public interface MonitorServiceManager {
    PageResult<ConsumerSummary> getConsumerSummariesByPage(String clusterType, String clusterName, String consumerName, int envId, int pageNo, int pageSize, Boolean allDelay);
}
