...
export default {
  ...
  methods: {
    ...
    async getClusterOptions() {
      ...
      const params = { envId: this.formData.envId, serviceType: 'KAFKA' }
    ...
    async getThemeOptions() {
      ...
      const params = { envId: this.formData.envId, clusterType: 'KAFKA', clusterName: this.formData.clusterName }
